...
INSERT INTO medical_users (user_id, active, password, username, role) VALUES (1, true, '$2a$10$6gNV5pNmtIkRFMuFfCOGweEQGfL5Xjxz2NAgoDMXgaqfVmp4j.by2', 'admin', 'ROLE_ADMIN');
INSERT INTO medical_users (user_id, active, password, username, role) VALUES (2, true, '$2a$10$2QSRMb3PQL8R1xckwz5Xwu.b/EyHn37Z6.AEpaGDE3Z7e/XH69Vke', 'altin', 'ROLE_EMPLOYEE');
INSERT INTO medical_users (user_id, active, password, username, role) VALUES (3, true, '$2a$12$7UsS35xTaqQ/cwNLfLnF4eCUBTJccJKQc/U0roz8BmMNHR2O0O6.a', 'test', 'ROLE_EMPLOYEE');
